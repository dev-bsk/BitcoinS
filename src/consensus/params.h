...
struct Params {
     ...
     * both chains, bitcoin and bitcoin staking are coming in sync with steps of this size. */
    int BPSRewardMatchStep;
    /** Block height at which BPSRewardMatch becomes active - rewards from
     * both chains, bitcoin and bitcoin staking are in sync as of this height. */
